...
export default function UseCasesPage() {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Use Cases</h1>
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 py-2 pl-10 pr-4 text-sm placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
          />
        </div>
      ...
      {filteredUseCases.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-12 text-center">
          <p className="text-gray-500 dark:text-gray-400">No use cases found matching your filters.</p>
          <button
