...
export function HumanCard({ human }: HumanCardProps) {
  ...
  return (
    <div className="bg-card dark:bg-gray-800 rounded-xl border border-border dark:border-gray-700 shadow-sm overflow-hidden">
      <div className="p-5">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="relative flex-shrink-0">
            {human.avatar.includes("dicebear") ? (
              ...
              <div className="w-14 h-14 rounded-full bg-muted dark:bg-gray-700 flex items-center justify-center">
            ...
            <div
              className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-border dark:border-gray-800 ${statusColors[human.status]}`}
            />
          </div>
        ...
        <button
          ...
          className="mt-4 w-full flex items-center justify-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground dark:text-gray-400 dark:hover:text-gray-200 transition-colors border-t border-border dark:border-gray-700 -mx-5 px-5 mt-4 pt-4"
        >
          {expanded ? (
            <>
      ...
      {expanded && (
        <div className="px-5 pb-5 border-t border-border dark:border-gray-700 pt-4">
          <h4 className="text-xs font-semibold text-muted-foreground dark:text-gray-400 uppercase tracking-wide mb-3">
            Past 8 Hours
          </h4>
